...
Este documento detalla el progreso del desarrollo de BitChat y las metas futuras para la terminal de soberanía criptográfica.
...
- [x] **Bundler Standalone**: Script `single.cjs` para generar un único archivo `bitchat.html` con todos los recursos inyectados (Inlining).
